...
def read_job_records() -> list[dict[str, object]]:
    ...
    for path in JOB_DIR.glob("infinity_*.json"):
        try:
...
TASKS: list[Task] = [
    ...
    Task(
        ...
        [
            ...
            Field("normal_vae", "Normal VAE", "weights/infinity_vae_d56_f8_14_patchify.pth"),
            Field("rgb_vae", "RGB VAE", "weights/infinity_vae_d56_f8_14_patchify.pth"),
            Field("vae_type", "VAE type", "14"),
            Field("spatial_patchify", "Spatial patchify", "1", choices=("0", "1")),
            Field("model_name", "模型名", "infinity_8b"),
            Field("init_model", "初始化模型", "weights/infinity_8b_weights"),
            ...
            Field("zero", "ZeRO", "3", choices=("0", "2", "3")),
    ...
    Task(
        ...
        [
            ...
            Field("vae_ckpt", "基础 VAE", "weights/infinity_vae_d56_f8_14_patchify.pth"),
            ...
            Field("codebook_dim", "Codebook dim", "14"),
            Field("spatial_patchify", "Spatial patchify", "1", choices=("0", "1")),
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="shell"):
            ...
            with Horizontal(id="keybar"):
                ...
                yield Static("q 退出    ↑↓ 选择任务    Enter/点击参数 编辑    r 运行    a 进入 tmux    s 会话    c 命令", id="keybar_text")
